...
> 状态：设计稿（v1.4 目标）。前端可点击原型见 [prototypes/image-browser.html](prototypes/image-browser.html)（在线版：https://claude.ai/artifact/4SpPknJEiUwBBjB4ATiGo9 ，右下角「导览」可跳到 5 个场景，勾选「显示设计标注」看设计说明）。
